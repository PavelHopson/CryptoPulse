...
- **Freemium-подписка** — бесплатный тариф с рекламой. Pro ($9.99/мес) снимает рекламу, открывает AI-аналитику, TradingView графики и неограниченное избранное
- **Whale Club ($49.99/мес)** — персональный менеджер, API-доступ, закрытый чат, альфа-сигналы
- **Реклама** — встроенные баннеры для пользователей бесплатного тарифа
